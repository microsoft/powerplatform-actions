...
// node_modules/@microsoft/powerplatform-cli-wrapper/dist/pac/getPacLogPath.js
var require_getPacLogPath = __commonJS({
  "node_modules/@microsoft/powerplatform-cli-wrapper/dist/pac/getPacLogPath.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var os_1 = require("os");
    var path_1 = require("path");
    function getPacLogPath({ runnersDir }) {
      return (0, path_1.resolve)(runnersDir, (0, os_1.platform)() === "win32" ? "pac" : "pac_linux", "tools", "logs", "pac-log.txt");
    }
    exports2.default = getPacLogPath;
  }
});
...
var require_exportSolution = __commonJS({
  "node_modules/@microsoft/powerplatform-cli-wrapper/dist/actions/exportSolution.js"(exports2) {
    ...
    var getPacLogPath_1 = require_getPacLogPath();
    var path = require("path");
    function exportSolution(parameters, runnerParameters, host) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        const pacLogs = (0, getPacLogPath_1.default)(runnerParameters);
        try {
...
// out/actions/create-environment/index.js
...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const result = yield (0, actions_1.createEnvironment)({
