...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parameterMap = taskParser.getHostParameterEntries(runnerParameters_1.runnerParameters.workingDir, "reset-environment");
        core.startGroup('reset-environment:');
        yield actions_1.resetEnvironment({
