...
process.env['INPUT_SOLUTION-INPUT-FILE'] = path.resolve(__dirname, '..', '..', 'src', 'test', 'data', 'emptySolution_0_1_0_0.zip');
process.env['INPUT_SOLUTION-NAME'] = 'emptySolution';
process.env['INPUT_SOLUTION-TARGET-FOLDER'] = path.resolve(__dirname, '..', '..', 'out', 'unpack solution');
