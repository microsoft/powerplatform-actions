...
//process.env['INPUT_ENVIRONMENT-ID'] = new URL(process.env['PA_BT_ORG_ID'] ?? 'https://davidjenD365-1.crm.dynamics.com').href;
...
process.env['INPUT_APPLICATION-NAME'] = 'Agent Productivity Tools';
