...
process.env['INPUT_ENVIRONMENT'] = new URL(process.env['PA_BT_ORG_URL'] ?? 'https://ppdevtools.crm.dynamics.com').href;
process.env['INPUT_APPLICATION-LIST'] = 'src/test/data/appsToInstall.json';
